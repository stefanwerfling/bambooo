...
export {SearchWidgetOnTemplateSelection, SearchWidgetOnTemplateResult, SearchWidgetOnEvent, SearchWidgetData, SearchWidget} from './v1/Base/Widget/Search/SearchWidget.js';
